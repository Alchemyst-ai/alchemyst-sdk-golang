# Alchemyst AI Go API Library

<!-- x-release-please-start-version -->

<a href="https://pkg.go.dev/github.com/stainless-sdks/alchemyst-ai-sdk-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/alchemyst-ai-sdk-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/stainless-sdks/alchemyst-ai-sdk-go" // imported as alchemystaisdk
)
```
...
```sh
go get -u 'github.com/stainless-sdks/alchemyst-ai-sdk-go@v0.0.1'
```
...
client.V1.Context.Add(context.TODO(), ...,
	// Override the header
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/alchemyst-ai-sdk-go/option).
...
if err != nil {
	...
	panic(err.Error()) // GET "/api/v1/context/add": 400 Bad Request { ... }
}
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/alchemyst-ai-sdk-go/issues) with questions, bugs, or suggestions.
