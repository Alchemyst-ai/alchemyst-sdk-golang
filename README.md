...
<a href="https://pkg.go.dev/github.com/Alchemyst-ai/alchemyst-sdk-golang"><img src="https://pkg.go.dev/badge/github.com/Alchemyst-ai/alchemyst-sdk-golang.svg" alt="Go Reference"></a>
...
```sh
go get -u 'github.com/Alchemyst-ai/alchemyst-sdk-golang@v0.2.0'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/Alchemyst-ai/alchemyst-sdk-golang/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/Alchemyst-ai/alchemyst-sdk-golang/issues) with questions, bugs, or suggestions.
